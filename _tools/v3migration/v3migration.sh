...
# usage: cd ${GOPATH}/src/github.com/chenyb888/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/chenyb888/gopsutil/|"github.com/shirou/gopsutil/v3/|g' @
...
sed -i "/github.com\/chenyb888\/gopsutil\/v3\/net/d" process/process_bsd.go
